...
void SPI_MASTinit(void)
{
	...
	/*SS pull up*/
	DIO_SETpinDir(DIO_PORTB,DIO_PIN4,DIO_INPUT);
	DIO_SETpinVal(DIO_PORTB,DIO_PIN4,DIO_HIGH);
	/*MOSI*/
	DIO_SETpinDir(DIO_PORTB,DIO_PIN5,DIO_OUTPUT);
	/*MISO*/
	DIO_SETpinDir(DIO_PORTB,DIO_PIN6,DIO_INPUT);
	/*SCK*/
...
void SPI_SLVinit(void)
{
	...
	/*MOSI*/
	DIO_SETpinDir(DIO_PORTB,DIO_PIN5,DIO_INPUT);
	/*MISO*/
	DIO_SETpinDir(DIO_PORTB,DIO_PIN6,DIO_OUTPUT);
	/*SCK*/
	DIO_SETpinDir(DIO_PORTB,DIO_PIN7,DIO_INPUT);
	/*Set SPI as a slave*/
